                        ...
                        <div class="card">
                            <div class="card-body">
                            	...
                            	<form  enctype="multipart/form-data" action="add_process.php" method="POST">
                            		<label>Tiêu đề</label>
                            		<input type="text" class="form-control m-b-15" placeholder="Tiêu đề" name="title">
                            		<label>Mô tả</label>
                            		<textarea  class="form-control" placeholder="Mô tả" aria-label="Withtextarea" name = "description"></textarea>
                            		<br>
                                    <label>Ảnh đại diện</label>
                                    <input type="file" class="form-control m-b-15"  value="<?= $post['thumbnail'] ?>" name="thumbnail">
                                    <br>
                                    <label>Nội dung</label>
                                    <textarea  id ="summernote" value="<?= $category['name'] ?>" name = "content"></textarea>
