            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Quản lý bài viết</h2>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../uploads/<?=$posts['thumbnail'] ?>" width='100px' height='100px'>
                                                    </td>
                                                    <td><?=$posts['title'] ?></td>
                                                    <td align="center">
                                                        <?php 
                                                    ...
                                                    <td align="center"><?=$posts['view_count'] ?></td>

                                                    <td align="center">
                                                        <a href="update.php?id=<?=$posts['id']?>" class="btn btn-primary btn-sm btn-tone m-r-5">Cập nhật</a>
                                                        
                                                        <a href="delete.php?id=<?=$posts['id']?>" class="btn btn-danger btn-sm btn-tone m-r-5">Xóa</a>
                                                    </td>
