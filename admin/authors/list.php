...
if(!isset($_SESSION['isLogin']) || $_SESSION['isLogin'] == false){
    ...
    $query = "SELECT * FROM authors WHERE deleted_at is null";
    //var_dump($query);
    //die;
    echo "ádasdadasd";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="update.php?id=<?=$auth['id']?>" class="btn btn-primary btn-sm btn-tone m-r-5">Cập nhật</a>
                                                        
                                                        <a href="delete.php?id=<?=$auth['id']?>" class="btn btn-danger btn-sm btn-tone m-r-5">Xóa</a>
                                                    </td>
