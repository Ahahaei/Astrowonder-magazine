						...
						<div class="row">
							<div class="col-md-9">
								<ul class="top-line-list">
									<li>
										<span class="city-weather">Việt Nam</span>
									...
									<li><span class="time-now clock" id="MyClockDisplay"  onload="showTime()"></span></li>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-left">
								...
								<li class="drop"><a class="home" href="index.php">Trang chủ</a></li>
								<?php
								$items = array('world', 'travel', 'tech', 'fashion', 'sport', 'food');
								$i=2 ;
								...
								?>
								<li class="drop"><a class="<?php echo $items[$i]?>" href="category.php?slug=<?=$cate['slug']?>"><?=$cate['name']?></a></li>
								<?php  $i++; }?>
<!--
...
-->
							...
							<form action="../client/search.php" method="GET" class="navbar-form navbar-right" role="search">
